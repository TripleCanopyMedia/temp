...
class xoo_wsc {
	...
	private function load_dependencies() {
		...
		include_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/xoo-wsc-functions.php';  
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_public, 'template_functions' );
		$this->loader->add_filter( 'pre_option_woocommerce_cart_redirect_after_add', $plugin_public, 'prevent_cart_redirect',10,1);
		$this->loader->add_action('wp_ajax_xoo_wsc_create_nonces',$plugin_public,'create_nonces');
			$this->loader->add_action('wp_ajax_nopriv_xoo_wsc_create_nonces',$plugin_public,'create_nonces');
		if(!is_admin() || wp_doing_ajax()){
			...
			$this->loader->add_action('wc_ajax_xoo_wsc_undo_item',$get_cart,'undo_item');
			$this->loader->add_action('woocommerce_add_to_cart',$get_cart,'on_add_to_cart');
